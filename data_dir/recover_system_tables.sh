...
for DIR in '/var/lib/scylla/data/system' '/var/lib/scylla/data/system_schema'; do
    ...
    do
        #sudo test -e $DIR/$i/snapshots/$1 && sudo rm -rf $DIR/$i/ && sudo find $DIR/$i/snapshots/$1 -type f -exec sudo -u scylla /bin/cp {} $DIR/$i/ \;
        #sudo test -e $DIR/$i/snapshots/$1 && sudo find $DIR/$i/snapshots/$1 -type f -exec sudo -u scylla /bin/cp {} $DIR/$i/ \;
