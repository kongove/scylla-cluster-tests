    ...
    def install_scylla(self, scylla_repo):
        ...
        if self.is_rhel_like():
            ...
            if self.is_ubuntu14():
                ...
                prepare_script = dedent("""
                    apt-get update
                    apt-get install apt-transport-https wget gnupg2 gnupg1-curl dirmngr -y
                    ...
                    echo "deb http://download.opensuse.org/repositories/home:/scylladb:/scylla-3rdparty-stretch/Debian_9.0/ /" |sudo tee /etc/apt/sources.list.d/scylla-3rdparty.list
                """)
                self.remoter.run('sudo bash -cxe "%s"' % prepare_script)
