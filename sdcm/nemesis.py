...
class Nemesis():  # pylint: disable=too-many-instance-attributes,too-many-public-methods
    ...
    def disrupt_mgmt_backup(self):
        ...
        succeeded, status = mgr_task.wait_for_task_done_status(timeout=10800)
    ...
    def break_streaming_task_and_rebuild(self, task='decommission'):
        """
        ...
        def is_streaming_started(nodetool_task='rebuild'):
            global used_streaming
        ...
        if used_streaming:
            ...
            self.log.debug('Streaming is not used. In latest Scylla, it is optional to use streaming for rebuild and decommission, and repair will not use streaming.')
