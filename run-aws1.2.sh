...
avocado run performance_regression_test.py:PerformanceRegressionTest.test_simple_regression --multiplex data_dir/your_config1.2.yaml --filter-only /run/backends/aws/us_west_1 /run/databases/scylla --filter-out /run/backends/libvirt  --show-job-log
