...
class UpgradeTest(FillDatabaseData):
    ...
    def test_rolling_upgrade(self):
        ...
        sst3_stress_queue = self.run_stress_thread(stress_cmd=stress_cmd_sst3)
        ...
        sst3_stress_queue = self.run_stress_thread(stress_cmd=stress_cmd_sst3_verify_read)
        ...
        sst3_stress_queue = self.run_stress_thread(stress_cmd=stress_cmd_sst3_verify_more)
